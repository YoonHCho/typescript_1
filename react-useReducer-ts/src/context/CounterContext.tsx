...
const initContextState: UseCounterContextType = {
  ...
  handleTextInput: (_e: ChangeEvent<HTMLInputElement>) => {}, // Use an underscore to indicate it's intentionally unused
};
...
type UseCounterTextHookType = {
  text: string;
  handleTextInput: (_e: ChangeEvent<HTMLInputElement>) => void;
};
